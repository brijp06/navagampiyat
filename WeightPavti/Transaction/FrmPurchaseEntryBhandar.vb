...
Public Class FrmPurchaseEntryBhandar
    Dim barc As String
    ...
    End Sub
    Public Sub chaln()
        Dim dt As DataTable = ob.Returntable("select * from acmain where Partyid=" & Val(Cname.Tag) & " and ch=0 and Department='" & Trim(Cmbdepartment.Text) & "' and ptype='Malavak'", ob.getconnection())
    ...
    Private Sub ButSave_Click(sender As Object, e As EventArgs) Handles ButSave.Click
        ...
        If sdate >= gFinYearBegin And sdate <= gFinYearEnd Then
            ...
            ob.Execute("Insert Into Acmain(Cid, Year_id, Department, Billtype, Billno, Billdate, PartyId, Acid, Remarks, gst, Basic, Roundoff, Netamt,ReceiptAmt,ptype,lessamt) Values(" & clsVariables.CompnyId & ",'" & clsVariables.WorkingYear & "'," & aq(Cmbdepartment.Text) & "," & aq(cmbType.Text) & "," & Val(Billno.Text) & ",'" & ob.DateConversion(billDt.Text) & "'," & Val(Cname.Tag) & "," & Val(acname.Tag) & ",N'" & Trim(Remarks.Text) & "'," & Val(tcgst.Text) & "," & Val(basci.Text) & "," & Val(Roundoff.Text) & "," & Val(tNetamt.Text) & "," & Val(tNetamt.Text) & ",'Purchase'," & Val(txtDisc.Text) & ")", ob.getconnection())
            If Val(txtDisc.Text) < 0 Then
                Dim spid As String
                spid = ob.FindOneString("Select pid from Item_Master Where Item_id=" & Dg.Rows(0).Cells(1).Tag & "", ob.getconnection())
                ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate, Acid, ACName, dramt,Remarks,cramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "'," & spid & ",N'" & Dg.Rows(0).Cells(1).Value & "'," & Val(tNetamt.Text) + Val(Math.Abs(Val(txtDisc.Text))) + Val(Math.Abs(Val(Roundoff.Text))) & ",N'" & Trim(Remarks.Text) & "',0,'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
                ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate,Acid, ACName, cramt,Remarks,dramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "'," & acname.Tag & ",N'" & acname.Text & "'," & Val(tNetamt.Text) & ",N'" & Trim(Remarks.Text) & "',0,'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
            Else
                For i As Integer = 0 To Dg.Rows.Count - 1
                    Dim spid As String
                    spid = ob.FindOneString("Select pid from Item_Master Where Item_id=" & Dg.Rows(i).Cells(1).Tag & "", ob.getconnection())
                    ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate, Acid, ACName, dramt,Remarks,cramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "'," & spid & ",N'" & Dg.Rows(i).Cells(1).Value & "'," & Dg.Rows(i).Cells(11).Value & ",N'" & Trim(Remarks.Text) & "',0,'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
                    ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate,Acid, ACName, cramt,Remarks,dramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "'," & acname.Tag & ",N'" & acname.Text & "'," & Dg.Rows(i).Cells(11).Value & ",N'" & Trim(Remarks.Text) & "',0,'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
                Next
            End If

            For i As Integer = 0 To Dg.Rows.Count - 1
                Dim iid As String = ob.FindOneString("select Size_id from Size_Master where Size_Name='" & Dg.Rows(i).Cells(2).Value & "'", ob.getconnection())
                ob.Execute("Insert Into Acstock(Cid, Year_id, Department, Billno, Billdate,Stockin, Stockout, Rate, Basic, CGST, SGST, CGSTAMT, SGSTAMT,ptype,itemid,Sizeid,barcode,billtype,PDTRate,MRP,Printrate,srno) Values(1,'" & clsVariables.WorkingYear & "','" & Cmbdepartment.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "'," & Dg.Rows(i).Cells(4).Value & ",0," & Dg.Rows(i).Cells(5).Value & "," & Dg.Rows(i).Cells(6).Value & "," & Dg.Rows(i).Cells(7).Value & "," & Dg.Rows(i).Cells(9).Value & "," & Dg.Rows(i).Cells(8).Value & "," & Dg.Rows(i).Cells(10).Value & ",'Purchase'," & Val(Dg.Rows(i).Cells(1).Tag) & ",'" & (iid) & "','" & Trim(Dg.Rows(i).Cells(3).Value) & "','" & cmbType.Text & "'," & Val(Dg.Rows(i).Cells(12).Value) & "," & Val(Dg.Rows(i).Cells(13).Value) & "," & Val(Dg.Rows(i).Cells(14).Value) & "," & Val(Dg.Rows(i).Cells(0).Value) & ")", ob.getconnection())
                Dim dt As DataTable = ob.Returntable("select * from ratemaster where itemid=" & Val(Dg.Rows(i).Cells(1).Tag) & " and sizeid=" & aq(iid) & " and barcode=" & aq(Dg.Rows(i).Cells(3).Value) & "", ob.getconnection())
                If dt.Rows.Count > 0 Then
                    ob.Execute("update ratemaster set rate=" & Val(Dg.Rows(i).Cells(12).Value) & " where itemid=" & Val(Dg.Rows(i).Cells(1).Tag) & " and sizeid=" & aq(iid) & " and barcode=" & aq(Dg.Rows(i).Cells(3).Value) & "", ob.getconnection())
                Else
                    ob.Execute("insert into ratemaster(itemid,sizeid,barcode,rate) values (" & Val(Dg.Rows(i).Cells(1).Tag) & "," & aq(iid) & "," & aq(Dg.Rows(i).Cells(3).Value) & "," & Val(Dg.Rows(i).Cells(12).Value) & ") ", ob.getconnection())
                End If
            Next
            chalantrue()
            If Val(Roundoff.Text) <> 0 Then
                ...
                Else
                    ...
                    'ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate, Acid, ACName, cramt,Remarks,dramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "'," & Val(dac) & ",N'90',0,N'" & Trim(Remarks.Text) & "'," & Val(Roundoff.Text) & ",'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
                    ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate, Acid, ACName, cramt,Remarks,dramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "',90,N'139'," & Val(Roundoff.Text) & ",N'" & Trim(Remarks.Text) & "',0,'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
                End If
            End If
            If Val(txtDisc.Text) < 0 Then
                ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate,Acid, ACName, cramt,Remarks,dramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "',90,N'" & acname.Text & "'," & Math.Abs(Val(txtDisc.Text)) & ",N'" & Trim(Remarks.Text) & "',0,'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
                'ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate,Acid, ACName, cramt,Remarks,dramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "'," & Val(dac) & ",N'" & acname.Text & "',0,N'" & Trim(Remarks.Text) & "'," & Math.Abs(Val(txtDisc.Text)) & ",'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
            End If
            If Val(txtDisc.Text) > 0 Then
                ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate,Acid, ACName, cramt,Remarks,dramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "'," & Val(dac) & ",N'" & acname.Text & "'," & Val(txtDisc.Text) & ",N'" & Trim(Remarks.Text) & "',0,'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
                ob.Execute("Insert Into Acdata(Cid, Year_id, Type, Docno, Docdate,Acid, ACName, cramt,Remarks,dramt,ptype,Department) Values(1,'" & clsVariables.WorkingYear & "','" & cmbType.Text & "'," & Billno.Text & ",'" & ob.DateConversion(billDt.Text) & "',231,N'" & acname.Text & "',0,N'" & Trim(Remarks.Text) & "'," & Val(txtDisc.Text) & ",'Purchase','" & Cmbdepartment.Text & "')", ob.getconnection())
            End If
    ...
    Public Sub chalantrue()
        For i As Integer = 0 To Dgchalan.Rows.Count - 1
            If Dgchalan.Rows(i).Cells(0).Value = True Then
                ob.Execute("Update Acmain Set ch=1 where Billno=" & Dgchalan.Rows(i).Cells(1).Value & " and department='" & Trim(Cmbdepartment.Text) & "' and ptype='Malavak'", ob.getconnection())
                ob.Execute("Update Acstock Set cht=1 where Billno=" & Dgchalan.Rows(i).Cells(1).Value & " and department='" & Trim(Cmbdepartment.Text) & "' and ptype='Malavak'", ob.getconnection())
            End If
        Next
    End Sub
    Public Sub clear()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If Dgchalan.Rows.Count > 0 Then
            ...
            For i As Integer = 0 To Dgchalan.Rows.Count - 1
                ...
                If Dgchalan.Rows(i).Cells(0).Value = True Then
                    Dim dt As DataTable = ob.Returntable("select * from Acstock where BillNo=" & Dgchalan.Rows(i).Cells(1).Value & " and Department='" & Trim(Cmbdepartment.Text) & "' and Cht=0", ob.getconnection())
                    If dt.Rows.Count > 0 Then
                        For ids As Integer = 0 To dt.Rows.Count - 1
                            Dg.Rows.Add()
                            Dg.Rows(Dg.Rows.Count - 1).Cells(0).Value = ids + 1
                            Dg.Rows(Dg.Rows.Count - 1).Cells(1).Tag = dt.Rows(i).Item("Itemid")
                            Dg.Rows(Dg.Rows.Count - 1).Cells(1).Value = ob.FindOneString("Select item_name from Item_master where Item_id=" & dt.Rows(i).Item("Itemid") & "", ob.getconnection())
                            Dg.Rows(Dg.Rows.Count - 1).Cells(2).Value = dt.Rows(i).Item("Stockin")
                            Dg.Rows(Dg.Rows.Count - 1).Cells(3).Value = dt.Rows(i).Item("Rate")
                            Dg.Rows(Dg.Rows.Count - 1).Cells(4).Value = dt.Rows(i).Item("Basic")
    ...
    Private Sub srno_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles srno.Validating
        For i As Integer = 0 To Dg.Rows.Count - 1
            If srno.Text = Dg.Rows(i).Cells(0).Value Then
                ...
                Itemid.Text = Dg.Rows(i).Cells(1).Tag
                itemname.Text = Dg.Rows(i).Cells(1).Value
                Sizename.Text = Dg.Rows(i).Cells(2).Value
                Barcode.Text = Dg.Rows(i).Cells(3).Value
                ...
                padtrate.Text = Dg.Rows(i).Cells(12).Value
                MRP.Text = Dg.Rows(i).Cells(13).Value
                Printrate.Text = Dg.Rows(i).Cells(14).Value
            End If
        Next
    End Sub
    ...
    Private Sub Sizename_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Sizename.Validating
        If Trim(Cmbdepartment.Text) = "BHANDAR" Then
            ...
            TxtFillnew("select Barcode from Acstock where Itemid=" & Val(itemname.Tag) & " and sizeid=" & aq(Sizename.Text) & "", Barcode)
            old()
    ...
    End Sub
    Public Sub old()
        If dgold.Rows.Count > 0 Then
            dgold.Rows.Clear()
        End If
        Dim dt As DataTable = ob.Returntable("select * from Acstock where Itemid=" & Val(itemname.Tag) & " and sizeid=" & aq(Sizename.Text) & " and ptype='Purchase' Order by billdate desc", ob.getconnection())
        For i As Integer = 0 To dt.Rows.Count - 1
            dgold.Rows.Add()
            dgold.Rows(dgold.Rows.Count - 1).Cells(0).Value = dt.Rows(i).Item("Billno")
            dgold.Rows(dgold.Rows.Count - 1).Cells(1).Value = Format(dt.Rows(i).Item("Billdate"), "dd/MM/yyyy")
            dgold.Rows(dgold.Rows.Count - 1).Cells(2).Value = dt.Rows(i).Item("Barcode")
            dgold.Rows(dgold.Rows.Count - 1).Cells(3).Value = dt.Rows(i).Item("MRP")
            dgold.Rows(dgold.Rows.Count - 1).Cells(4).Value = dt.Rows(i).Item("PDTRate")
            ' dgold.Rows(dgold.Rows.Count - 1).Cells(2).Style.Font = New Font("SHREE-GUJ-0768-S02", 12, FontStyle.Regular)
            dgold.Rows(dgold.Rows.Count - 1).DefaultCellStyle.Font = New Font("HARIKRISHNA", 12, FontStyle.Regular)
        Next
    End Sub
    Public Sub TxtFillnew(ByVal Sqlstring As String, ByVal txtBox As TextBox)
        Dim sStringColl As New AutoCompleteStringCollection
        Dim qryCity As String
        Dim SqlConnString As String = "Password=advsys;Data Source=" & servername & ";Initial Catalog=" & dbname & ";Integrated Security=False;Persist Security Info=False;User ID=advsys;Max Pool Size=5000;Connect Timeout=0"
        qryCity = "SELECT DISTINCT NAME FROM ACMASTER  ORDER By NAME"
    ...
    Private Sub Printrate_KeyDown(sender As Object, e As KeyEventArgs) Handles Printrate.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            If Val(srno.Text) > Dg.Rows.Count Then
                ...
                Dg.Rows(srno.Text - 1).Cells(12).Value = padtrate.Text
                Dg.Rows(srno.Text - 1).Cells(13).Value = MRP.Text
                Dg.Rows(srno.Text - 1).Cells(14).Value = Printrate.Text
    ...
    Private Sub Billno_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Billno.Validating
        ...
        If dt.Rows.Count > 0 Then
            If MessageBox.Show("Do You Want To Edit This Entry...?", Application.ProductName, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                ...
                Dim dts As DataTable = ob.Returntable("select * from acstock where billno=" & Val(Billno.Text) & " and Billtype='" & Trim(cmbType.Text) & "' and Department='" & Trim(Cmbdepartment.Text) & "' and ptype='Purchase' and year_id='" & clsVariables.WorkingYear & "' Order by srno", ob.getconnection())
                If Dg.Rows.Count > 0 Then
                    Dg.Rows.Clear()
                End If
                For i As Integer = 0 To dts.Rows.Count - 1
                    ...
                    Dg.Rows(i).Cells(3).Value = dts.Rows(i).Item("Barcode")
                    Dim sid As String = ob.FindOneString("select sizeid from Acstock where barcode='" & dts.Rows(i).Item("Barcode") & "' and ptype='Purchase' and billtype='" & cmbType.Text & "'", ob.getconnection())
                    Dg.Rows(i).Cells(2).Value = ob.FindOneString("select Size_Name from Size_Master where Size_id='" & Trim(sid) & "'", ob.getconnection())
                    ...
                    Dg.Rows(i).Cells(11).Value = Val(dts.Rows(i).Item("Rate")) * Val(dts.Rows(i).Item("Stockin"))
                    Dg.Rows(i).Cells(12).Value = dts.Rows(i).Item("PDTRate")
                    Dg.Rows(i).Cells(13).Value = dts.Rows(i).Item("MRP")
                    Dg.Rows(i).Cells(14).Value = dts.Rows(i).Item("Printrate")
                    Dg.Rows(i).Cells(2).Style.Font = New Font("SHREE-GUJ-0768-S02", 12, FontStyle.Regular)
    ...
    Private Sub Roundoff_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Roundoff.Validating
        ...
        Else
            'Roundoff.Text = Val(tNetamt.Text) - Val(Roundoff.Text)
            'Roundoff.Text = Format(Val(Roundoff.Text), "#0.00")
            tNetamt.Text = Val(tNetamt.Text) + Val(Roundoff.Text)
            'tNetamt.Text = Format(Math.Round(Val(tNetamt.Text)), "######0.00")'
        End If
    End Sub
