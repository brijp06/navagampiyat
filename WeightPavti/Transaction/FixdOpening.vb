...
Public Class FixdOpening
    ...
    Private Sub MemberInward_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Billno.Text = ob.FindOneString("select isnull(max(Billno),0)+1 from Acmain where ptype='fdOpening'", ob.getconnection())
        acname.Tag = 3
    ...
    Private Sub Billno_KeyDown(sender As Object, e As KeyEventArgs) Handles Txtremark.KeyDown, Period.KeyDown, percent.KeyDown, payac.KeyDown, sname.KeyDown, Netamt.KeyDown, duedt.KeyDown, cmbtype.KeyDown, Billno.KeyDown, billDt.KeyDown, acname.KeyDown, Fixno.KeyDown
