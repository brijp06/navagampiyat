...
Public Class FixdReceiptReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Fixd Receipt Report")
        item = Dg.Items.Add("Fixd Opening Report")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        'End If
        If Dg.SelectedItems(0).SubItems(0).Text = "Fixd Receipt Report" Then
            ...
            clsVariables.Repheader = "Fixd Receipt Report"
            clsVariables.ReportName = "FixdReceiptReport.rpt"
            Dim frm As New Reportform
            frm.Show()
        Else
            ssql = "{Acmain.Billdate}>=#" & ob.DateConversion(TxtfromDate.Text) & "#"
            ssql = ssql & " and {Acmain.Billdate}<=#" & ob.DateConversion(TxtToDate.Text) & "#"
            ssql = ssql & " and {Acmain.Ptype}='Opening'"
            ssql = ssql & " and {Acmain.Department}='Fixd'"
            clsVariables.ReportSql = ssql
            clsVariables.FromDate = TxtfromDate.Text
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Fixd Opening Report"
            clsVariables.ReportName = "FixdOpeningReport.rpt"
            Dim frm As New Reportform
            frm.Show()
        End If
    End Sub
