...
Public Class TradingAccountReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Trading Account Report")
        item = Dg.Items.Add("Trading Account Group Wise Report")
        item = Dg.Items.Add("Trading Account Report T Format")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Dg.SelectedItems(0).SubItems(0).Text = "Trading Account Report" Then
            tarij()
            ssql = "{Account_group_master.Final_Report_Type}='Trading Account'"
            ...
            clsVariables.Repheader = "Treding Account Report"
            clsVariables.ReportName = "FinalTradingAccount.rpt"
            Dim frm As New Reportform
            frm.Show()
        ElseIf Dg.SelectedItems(0).SubItems(0).Text = "Trading Account Group Wise Report" Then
            tarij()
            ssql = "{Account_group_master.Final_Report_Type}='Trading Account'"
            ssql = ssql & " and {Joint_Trial_Balance.Company_id}=" & clsVariables.CompnyId
            clsVariables.ReportSql = ssql
            ...
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Treding Account Report"
            clsVariables.ReportName = "FinalTradingGroupWiseTradingAccount.rpt"
            Dim frm As New Reportform
            frm.Show()
        Else
            tarij()
            ssql = "{Ac_group_master.Final_Report_Type}='Trading Account'"
            ssql = ssql & " and {Joint_Trial_Balance.Company_id}=" & clsVariables.CompnyId
            clsVariables.ReportSql = ssql
            clsVariables.FromDate = TxtfromDate.Text
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Treding Account Report"
            clsVariables.ReportName = "JointTradingAccountTFormat.rpt"
            Dim frm As New Reportform
            frm.Show()
        End If
    End Sub
