...
Public Class MalavakReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("MalAvak Detail Report")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Mal Avak Report"
            clsVariables.ReportName = "Malavakreportd.rpt"
            Dim frm As New Reportform
            frm.Show()
        End If
    End Sub
