...
Public Class SalesReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Sales Detail Report")
        item = Dg.Items.Add("Sales Summary Report")
        item = Dg.Items.Add("Sales Datewise Report")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Dg.SelectedItems(0).SubItems(0).Text = "Sales Detail Report" Then
            ...
            clsVariables.Repheader = "Sales Report"
            clsVariables.ReportName = "DailyCashSalesReport.rpt"
            Dim frm As New Reportform
            frm.Show()
            '
        ElseIf Dg.SelectedItems(0).SubItems(0).Text = "Sales Summary Report" Then
            ssql = "{Acmain.Billdate}>=#" & ob.DateConversion(TxtfromDate.Text) & "#"
            ssql = ssql & " and {Acmain.Billdate}<=#" & ob.DateConversion(TxtToDate.Text) & "#"
            ssql = ssql & " and {Acmain.Ptype}='Sales'"
            ssql = ssql & " and {Acmain.Department}='" & Trim(Cmbdepartment.Text) & "'"
            ...
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Sales Report"
            clsVariables.ReportName = "DailyCashSalesReportd.rpt"
            Dim frm As New Reportform
            frm.Show()
        Else
            ssql = "{Acmain.Billdate}>=#" & ob.DateConversion(TxtfromDate.Text) & "#"
            ...
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Sales Report"
            clsVariables.ReportName = "DailyCashSalesReportdate.rpt"
            Dim frm As New Reportform
            frm.Show()
        End If
    End Sub
