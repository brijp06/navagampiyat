...
Public Class LoanPaymenttReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Loan Payment Report")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ssql = ssql & " and {Acmain.Ptype}='LoanPayment'"
        ssql = ssql & " and {Acmain.Billtype}<>'Opening'"

        clsVariables.ReportSql = ssql
            clsVariables.FromDate = TxtfromDate.Text
            clsVariables.ToDate = TxtToDate.Text
        clsVariables.Repheader = "Loan Payment Report"
        clsVariables.ReportName = "LoanPaymetReport.rpt"
