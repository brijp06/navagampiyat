...
Public Class FixdLedgerReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Fixd Ledger Report")
        ' item = Dg.Items.Add("Monthly Payment Summary Report")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Dg.SelectedItems(0).SubItems(0).Text = "Fixd Ledger Report" Then
            ...
            clsVariables.Repheader = Dg.SelectedItems(0).SubItems(0).Text
            clsVariables.ReportName = "FixdLedgerReport.rpt"
        ...
        Else
            ...
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = Dg.SelectedItems(0).SubItems(0).Text
            clsVariables.ReportName = "MonthlyPaymentSummaryReport.rpt"
            Dim frm As New Reportform
            frm.Show()
        End If
    End Sub
    ...
    Private Sub Acname_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'If Acname.Text <> "" Then
