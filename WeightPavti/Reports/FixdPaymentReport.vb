...
Public Class FixdPaymentReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Fixd Payment Report")
        item = Dg.Items.Add("Fixd Intrest Payment Report")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim ssql As String = ""
        If Dg.SelectedItems(0).SubItems(0).Text = "Fixd Payment Report" Then
            ...
            clsVariables.Repheader = "Fixd Payment Report"
            clsVariables.ReportName = "FixdPaymentReport.rpt"
            Dim frm As New Reportform
            frm.Show()
        Else
            ssql = "{tblintrest.Billdate}>=#" & ob.DateConversion(TxtfromDate.Text) & "#"
            ssql = ssql & " and {tblintrest.Billdate}<=#" & ob.DateConversion(TxtToDate.Text) & "#"
            clsVariables.ReportSql = ssql
            clsVariables.FromDate = TxtfromDate.Text
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Fixd Intrest Payment Report"
            clsVariables.ReportName = "FixdIntPaymentReport.rpt"
            Dim frm As New Reportform
            frm.Show()
        End If
