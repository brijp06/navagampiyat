...
Public Class MangnaReceiptReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Mangna Receipt Report")
        item = Dg.Items.Add("Old Mangna Receipt Report")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        '
        If Dg.SelectedItems(0).SubItems(0).Text = "Mangna Receipt Report" Then
            Dim ssql As String = ""
            ...
            clsVariables.Repheader = "Mangna Receipt Report"
            clsVariables.ReportName = "MemberReceiptReport.rpt"
        ...
        Else
            ...
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Mangna Receipt Report"
            clsVariables.ReportName = "OLDMemberReceiptReport.rpt"
            Dim frm As New Reportform
            frm.Show()
        End If
