...
Public Class ProfitandLossAccountReport
    ...
    Private Sub PurchaseReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        item = Dg.Items.Add("Profit And Loss Report")
        item = Dg.Items.Add("Profit And Loss Report T Format")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Dg.SelectedItems(0).SubItems(0).Text = "Profit And Loss Report" Then
            tarij()
            ssql = "{Account_group_master.Final_Report_Type}='Profit & Loss Account'"
            ...
            clsVariables.Repheader = "Profit And Loss Report"
            clsVariables.ReportName = "FinalProfitAndLossTFormat.rpt"
            Dim frm As New Reportform
            frm.Show()
        Else
            tarij()
            ssql = "{Ac_group_master.Final_Report_Type}='Profit & Loss Account'"
            ssql = ssql & " and {Joint_Trial_Balance.Company_id}=" & clsVariables.CompnyId
            clsVariables.ReportSql = ssql
            clsVariables.FromDate = TxtfromDate.Text
            clsVariables.ToDate = TxtToDate.Text
            clsVariables.Repheader = "Profit And Loss Report"
            clsVariables.ReportName = "JointProfitLossTFormat.rpt"
            Dim frm As New Reportform
            frm.Show()
    ...
    Public Sub tarij()
        ...
        dGrossProfitLoss = 0
        ssql = "SELECT sum(ho_cr) as Credit , sum(ho_dr) as debit FROM Joint_Trial_Balance  as jtb, Account_Master  as am, Account_Group_Master  as agm "
        ssql = ssql & " WHERE jtb.Company_id = am.Company_id and jtb.Account_id = am.Account_id and am.Company_id = agm.Company_id and am.Group_id = agm.Group_id "
        ssql = ssql & " and agm.Final_Report_type = 'Trading Account' and jtb.company_id = " & clsVariables.CompnyId
